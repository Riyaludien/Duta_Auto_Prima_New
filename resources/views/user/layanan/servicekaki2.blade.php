...
@section('content')
    ...
    <div class="container mb-5">
        ...
        @endif
        <div class="p-5 mb-4 rounded text-white" style="background: linear-gradient(135deg,#1e1e1e,#343a40);">
            <h1 class="fw-bold">Service Kaki-Kaki Mobil</h1>
            <p class="mb-3">
                Menjaga kenyamanan dan kestabilan kendaraan Anda saat berkendara.
                Performa kaki-kaki yang optimal akan memberikan pengalaman berkendara yang lebih aman dan nyaman.
            </p>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-3">
                    <div class="card h-100 border-0 shadow-sm">
                        <img src="https://img.freepik.com/free-photo/car-repair-concept_23-2148990243.jpg"
                ...
                <div class="col-md-3">
                    <div class="card h-100 border-0 shadow-sm">
                        <img src="https://img.freepik.com/free-photo/worn-car-tire_23-2148982365.jpg" class="card-img-top"
                            style="height:180px; object-fit:cover;">
                        <div class="card-body">
                ...
                <div class="col-md-3">
                    <div class="card h-100 border-0 shadow-sm">
                        <img src="https://img.freepik.com/free-photo/car-steering-wheel_23-2148990211.jpg"
                            class="card-img-top" style="height:180px; object-fit:cover;">
                        <div class="card-body">
