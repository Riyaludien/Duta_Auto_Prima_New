...
@section('content')
    ...
    <div class="container mb-5">
        ...
        <div class="p-5 mb-4 rounded-4 text-white"
            ...
            <h1 class="fw-bold">Service Kaki-Kaki Mobil</h1>

            <p class="mb-3" style="max-width:600px;">
                Menjaga kenyamanan dan kestabilan kendaraan saat digunakan.
                Sistem kaki-kaki yang optimal membantu mengurangi getaran,
                meningkatkan kontrol, serta memberikan pengalaman berkendara yang lebih aman.
            </p>
        ...
        <div class="mb-5">
            <h4 class="fw-bold mb-4">Tanda-Tanda Kaki-Kaki Bermasalah</h4>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-3">
                    <div class="card h-100 border-0 shadow-sm">
                        <img src="{{ asset('storage/katalog/bunyii.jpeg') }}" class="card-img-top"
                            style="height:180px; object-fit:cover;">

                        <div class="card-body">
                            <h6 class="fw-bold">Bunyi Saat Jalan Rusak</h6>
                            <p class="text-muted small mb-0">
                                Muncul suara tidak normal saat melewati jalan tidak rata.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card h-100 border-0 shadow-sm">
                        <img src="{{ asset('storage/katalog/limbung.jpeg') }}" class="card-img-top"
                            style="height:180px; object-fit:cover;">
                        <div class="card-body">
                            <h6 class="fw-bold">Kendaraan Tidak Stabil</h6>
                            <p class="text-muted small mb-0">
                                Mobil terasa limbung atau kurang stabil saat dikendarai.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card h-100 border-0 shadow-sm">
                        <img src="{{ asset('storage/katalog/ban.jpeg') }}" class="card-img-top"
                            style="height:180px; object-fit:cover;">
                        <div class="card-body">
                            <h6 class="fw-bold">Ban Aus Tidak Merata</h6>
                            <p class="text-muted small mb-0">
                                Permukaan ban terlihat tidak rata atau cepat aus.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card h-100 border-0 shadow-sm">
                        <img src="{{ asset('storage/katalog/stir.jpeg') }}" class="card-img-top"
                            style="height:180px; object-fit:cover;">
                        <div class="card-body">
                            <h6 class="fw-bold">Setir Tidak Lurus</h6>
                            <p class="text-muted small mb-0">
                                Posisi setir tidak kembali lurus saat kendaraan berjalan.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="mb-5">
            <h4 class="fw-bold">Pentingnya Perawatan Kaki-Kaki</h4>
            <p class="text-muted">
                Sistem kaki-kaki memiliki peran penting dalam menjaga keseimbangan dan kenyamanan kendaraan.
                Jika tidak dirawat dengan baik, dapat mempengaruhi performa berkendara dan meningkatkan risiko kerusakan
                pada komponen lainnya.
                Pemeriksaan dan perawatan secara berkala sangat disarankan untuk menjaga kondisi kendaraan tetap optimal.
            </p>
        </div>
        ...
        <div class="text-center mt-5 p-4 bg-light rounded">
            <h4 class="fw-bold">Butuh Pemeriksaan Kaki-Kaki?</h4>
            <p class="text-muted">
                Lakukan pengecekan sejak dini untuk menghindari kerusakan yang lebih serius.
            </p>
