...
@section('content')
    ...
    <div class="container mb-5">
        <div class="p-5 mb-4 rounded-4 text-white"
            ...
            <h1 class="fw-bold">Service AC Mobil</h1>

            <p class="mb-3" style="max-width:600px;">
                Menjaga kenyamanan berkendara dengan sistem pendingin yang optimal.
                Perawatan AC secara rutin membantu menjaga sirkulasi udara tetap bersih,
                menghilangkan bau tidak sedap, serta memastikan suhu kabin tetap sejuk dan stabil.
            </p>

            <button class="btn rounded-pill px-4" style="background:white; color:var(--primary-blue); font-weight:600;"
        ...
        <div class="mb-5">
            <h4 class="fw-bold mb-4">Tanda-Tanda AC Perlu Diservis</h4>

            <div class="row g-4">

                <div class="col-md-3">
                    <div class="card h-100 border-0 shadow-sm">
                        <img src="{{ asset('storage/katalog/ac1.jpeg') }}" style="height:180px; object-fit:cover;">
                        <div class="card-body">
                            <h6 class="fw-bold">AC Tidak Dingin</h6>
                            <p class="text-muted small mb-0">
                                Udara yang keluar tidak lagi sejuk seperti biasanya.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card h-100 border-0 shadow-sm">
                        <img src="{{ asset('storage/katalog/ac2.jpeg') }}" style="height:180px; object-fit:cover;">
                        <div class="card-body">
                            <h6 class="fw-bold">Muncul Bau Tidak Sedap</h6>
                            <p class="text-muted small mb-0">
                                Filter kabin kotor atau evaporator berjamur.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card h-100 border-0 shadow-sm">
                        <img src="{{ asset('storage/katalog/ac3.jpeg') }}" style="height:180px; object-fit:cover;">
                        <div class="card-body">
                            <h6 class="fw-bold">Suara Berisik</h6>
                            <p class="text-muted small mb-0">
                                Kompresor atau blower mulai mengalami gangguan.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card h-100 border-0 shadow-sm">
                        <img src="{{ asset('storage/katalog/ac4.jpeg') }}" style="height:180px; object-fit:cover;">
                        <div class="card-body">
                            <h6 class="fw-bold">Embun Berlebihan</h6>
                            <p class="text-muted small mb-0">
                                Sirkulasi udara tidak optimal atau ada masalah pada sistem AC.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="mb-5">
                <h4 class="fw-bold">Pentingnya Service AC Secara Berkala</h4>
                <p class="text-muted">
                    Sistem AC mobil berperan penting dalam menjaga kenyamanan selama berkendara.
                    Tanpa perawatan yang rutin, kinerja AC dapat menurun akibat kotoran,
                    kebocoran freon, atau kerusakan komponen.
                    Dengan melakukan service AC secara berkala, udara dalam kabin tetap bersih,
                    suhu tetap stabil, dan komponen AC dapat bertahan lebih lama.
                </p>
            </div>
        </div>
        ...
        <div class="text-center mt-5 p-4 bg-light rounded">
            <h4 class="fw-bold">AC mobil sudah tidak dingin? Udara kabin mulai kurang nyaman?</h4>
            <p class="text-muted">
                Lakukan service AC secara berkala untuk menjaga kenyamanan berkendara dan kualitas udara di dalam kabin
                tetap
                segar.
                <br>
                Jangan tunggu sampai AC benar-benar rusak. Service sekarang agar tetap dingin dan bebas bau.
            </p>
