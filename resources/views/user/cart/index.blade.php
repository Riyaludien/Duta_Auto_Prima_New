        ...
        <form action="{{ route('checkout') }}" method="POST" class="row g-4 w-100">
            ...
            <div class="col-lg-8">
                ...
                <div class="card border-0 shadow-sm mb-3 cart-card selectable-card" data-id="{{ $item->id }}">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <!-- CHECKBOX -->
                        <input type="checkbox" name="selected_items[]" value="{{ $item->id }}" class="item-checkbox d-none" data-harga="{{ $item->barang->harga * $item->jumlah }}">
                        <!-- IMAGE -->
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <button type="button" class="btn btn-sm btn-outline-secondary" onclick="updateQty({{ $item->id }}, 'minus')">-</button>

                            <span class="fw-semibold" id="qty2-{{ $item->id }}">
                                {{ $item->jumlah }}
                            </span>

                            <button type="button" class="btn btn-sm btn-outline-secondary" onclick="updateQty({{ $item->id }}, 'plus')">+</button>
                        </div>
                        ...
                        <!-- DELETE -->
                        <button type="button" onclick="deleteItem({{ $item->id }})" class="btn btn-sm btn-light text-danger">
                            🗑
                        </button>
            ...
            <div class="col-lg-4">
                <div class="card border-0 shadow-lg p-4 summary-card">
                    ...
                    <div id="infoRekening" class="p-3 mb-3" style="display:none; background:#e0f2fe; border-radius:12px;">
...
<div id="popupWA" class="popup-wa">
    <div class="popup-content">
        ...
        <div class="d-flex gap-2">
            <a href="https://wa.me/6283838762064?text={{ urlencode(session('wa_message')) }}" target="_blank" class="btn btn-success w-100">
                💬 Chat Admin
            </a>
