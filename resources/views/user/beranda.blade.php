            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    <div class="hero-slide"
                        style="background: linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.3)), url('{{ asset('images/banner-1.jpg') }}');">
                ...
                <div class="carousel-item">
                    <div class="hero-slide"
                        style="background: linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.3)), url('{{ asset('images/banner-2.jpg') }}');">
                        <div class="container-fluid px-5">
                ...
                <div class="carousel-item">
                    <div class="hero-slide"
                        style="background: linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.3)), url('{{ asset('images/banner-3.jpg') }}');">
                        <div class="container-fluid px-5">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="mobil-pane">
                    <div class="row g-3 row-cols-2 row-cols-md-4">
                        ...
                        <div class="col">
                            <a href="{{ route('layanan.kategori', 'servicekaki2') }}" class="service-icon-box">
                                <i class="bi bi-tools"></i>
                                <span>Service<br>Kaki-Kaki</span>
                            </a>
                        </div>

                        <div class="col">
                            <a href="{{ route('layanan.kategori', 'gantioli') }}" class="service-icon-box">
                                <i class="bi bi-droplet-fill"></i>
                                <span>Ganti<br>Oli</span>
                            </a>
                        </div>
